...
public class ControllerRebreanu {
    ...
    public static void start() {
        ...
        op1.SetName("op1");
        op1.Value = new TransferOperation("localhost", "1080", "iRbr_PTL1");
        pn.PlaceList.add(op1);

        DataTransfer op2 = new DataTransfer();
        op2.SetName("op2");
        op2.Value = new TransferOperation("localhost", "1080", "iRbr_PTL2");
        pn.PlaceList.add(op2);

        DataTransfer op3 = new DataTransfer();
        op3.SetName("op3");
        op3.Value = new TransferOperation("localhost", "1080", "iRbr_PTL3");
        pn.PlaceList.add(op3);

        DataTransfer op4 = new DataTransfer();
        op4.SetName("op4");
        op4.Value = new TransferOperation("localhost", "1080", "iRbr_PTL4");
        ...
        grdTf4_1.Activations.add(new Activation(t_f4, "Five", TransitionOperation.DynamicDelay, ""));
        t_f4.GuardMappingList.add(grdTf4_1);

        GuardMapping grdTf4_2 = new GuardMapping();
        grdTf4_2.condition = Tf4Ct3;
        grdTf4_2.Activations.add(new Activation(t_f4, "Ten", TransitionOperation.DynamicDelay, ""));
