...
public class ControllerP4 {
    ...
    public static void start() {
        ...
        pn.PetriNetName = "Controller Rebreanu P4";
        pn.NetworkPort = 1095;
        ...
        P_TL.SetName("P_TL");
        P_TL.Value = new TransferOperation("localhost", "1080", "iRbr_CPTL4");
        pn.PlaceList.add(P_TL);

        DataTransfer P_PTL = new DataTransfer();
        P_PTL.SetName("P_PTL");
        P_PTL.Value = new TransferOperation("localhost", "1080", "iRbr_PPTL4");
