...
public class ControllerP2 {
    ...
    public static void start() {
        ...
        pn.PetriNetName = "Controller Rebreanu P2";
        pn.NetworkPort = 1093;
        ...
        P_TL.SetName("P_TL");
        P_TL.Value = new TransferOperation("localhost", "1080", "iRbr_CPTL2");
        pn.PlaceList.add(P_TL);

        DataTransfer P_PTL = new DataTransfer();
        P_PTL.SetName("P_PTL");
        P_PTL.Value = new TransferOperation("localhost", "1080", "iRbr_PPTL2");
