...
public class ControllerP1 {
    ...
    public static void start() {
        ...
        pn.PetriNetName = "Controller Ulpia P1";
        pn.NetworkPort = 1077;
        ...
        P_TL.SetName("P_TL");
        P_TL.Value = new TransferOperation("localhost", "1080", "iUlp_CPTL1");
        pn.PlaceList.add(P_TL);

        DataTransfer P_PTL = new DataTransfer();
        P_PTL.SetName("P_PTL");
        P_PTL.Value = new TransferOperation("localhost", "1080", "iUlp_PPTL1");
