...
public class ControllerP4 {

    public static void start() {
        PetriNet pn = new PetriNet();
        pn.PetriNetName = "Controller Drubeta P4";
        pn.NetworkPort = 1090;
        ...
        P_TL.SetName("P_TL");
        P_TL.Value = new TransferOperation("localhost", "1080", "iDrub_CPTL4");
        pn.PlaceList.add(P_TL);

        DataTransfer P_PTL = new DataTransfer();
        P_PTL.SetName("P_PTL");
        P_PTL.Value = new TransferOperation("localhost", "1080", "iDrub_PPTL4");
