...
public class ControllerP3 {
    ...
    public static void start() {
        ...
        pn.PetriNetName = "Controller Vuia P3";
        pn.NetworkPort = 1101;
        ...
        P_TL.SetName("P_TL");
        P_TL.Value = new TransferOperation("localhost", "1080", "iVuia_CPTL3");
        pn.PlaceList.add(P_TL);

        DataTransfer P_PTL = new DataTransfer();
        P_PTL.SetName("P_PTL");
        P_PTL.Value = new TransferOperation("localhost", "1080", "iVuia_PPTL3");
